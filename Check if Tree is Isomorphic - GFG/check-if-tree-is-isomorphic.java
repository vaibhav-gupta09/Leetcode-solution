...
{ 
    ...
    {   
        ...
        if(root1.left.data==root2.left.data && root1.right.data == root2.right.data)
            flag |= isIsomorphic(root1.left, root2.left) && isIsomorphic(root1.right, root2.right);
        
        if(root1.left.data==root2.right.data)
            flag |= isIsomorphic(root1.left, root2.right) && isIsomorphic(root1.right, root2.left);
